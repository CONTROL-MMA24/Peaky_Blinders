    ...
    {% if page == "messages" %}
        ...
        <div class="card">
            ...
            <form action="/send_player_message" method="post">
                ...
                <input class="input" name="recipient" list="player-list" placeholder="Username" required>
                ...
                <input class="input" name="subject" maxlength="120" required>
            ...
            <div class="message-card {% if not message.is_read %}unread{% endif %}">
                ...
                <div>
                    <form action="/message_action" method="post">
                        ...
                        <button class="btn" name="action" value="delete">{{ t("delete") }}</button>
                    </form>
                </div>
            </div>
            {% endfor %}
                ...
                <div class="ranking-search-result">
                    ...
                    <div>
                        ...
                        <div class="ranking-search-meta">
                            ...
                            <span><b>EXP:</b> {{ searched_player.exp }}</span>
                            <span><b>Power:</b> {{ power_score(searched_player) }}</span>

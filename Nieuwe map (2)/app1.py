        ...
        <div class="vehicle-section">
            ...
            <div class="vehicle-grid">
                ...
                <div class="vehicle-card">
                    <div class="vehicle-image" style="--vehicle-tone: {{ vehicle.tone }}; {% if vehicle.image %}background-image: linear-gradient(rgba(0,0,0,.02),rgba(0,0,0,.58)), url('{{ vehicle.image }}');{% endif %}">
                        <div class="vehicle-silhouette">

...
<div class="app-shell">
    <aside class="sidebar">
        ...
        <div class="nav grouped-nav">
            <div class="menu-section">
                ...
                <a href="/messages" class="{% if page == 'messages' %}active{% endif %}">Messages{% set unread = unread_message_count(user) %}{% if unread > 0 %}<span class="badge">{{ unread }}</span>{% endif %}</a>
                <a href="/ranking" class="{% if page == 'ranking' %}active{% endif %}">Rankings</a>
            </div>
            <div class="menu-section">
                <div class="menu-header">📦 Logistics</div>
                <a href="/market" class="{% if page == 'market' %}active{% endif %}">Smuggling</a>
                <a href="/cargo" class="{% if page == 'cargo' %}active{% endif %}">Cargo</a>
                <a href="/traveling" class="{% if page == 'traveling' %}active{% endif %}">Traveling</a>
                <a href="/warehouse" class="{% if page == 'warehouse' %}active{% endif %}">Warehouse</a>
            </div>
            <div class="menu-section">
                <div class="menu-header">🔫 Crime</div>
                <a href="/" class="{% if page == 'crime' %}active{% endif %}">Crimes</a>
                <a href="/heists" class="{% if page == 'heists' %}active{% endif %}">Heists</a>
                <a href="/protection" class="{% if page == 'protection' %}active{% endif %}">Protection</a>
                <a href="/bullets" class="{% if page == 'bullets' %}active{% endif %}">Weapons</a>
            </div>
            <div class="menu-section">
                <div class="menu-header">🚗 Empire</div>
                <a href="/garage" class="{% if page == 'garage' %}active{% endif %}">Garage</a>
                <a href="/assets" class="{% if page == 'assets' %}active{% endif %}">Businesses</a>
                <a href="/properties" class="{% if page == 'properties' %}active{% endif %}">Properties</a>
                <a href="/casino" class="{% if page == 'casino' %}active{% endif %}">Casinos</a>
                <a href="/licenses" class="{% if page == 'licenses' %}active{% endif %}">Licenses</a>
                <a href="/influence" class="{% if page == 'influence' %}active{% endif %}">Influence</a>
            </div>
            <div class="menu-section">
                <div class="menu-header">👪 Family</div>
                <a href="/family" class="{% if page == 'family' %}active{% endif %}">Family</a>
                <a href="/territories" class="{% if page == 'territories' %}active{% endif %}">Territories</a>
            </div>
            <div class="menu-section">
                <div class="menu-header">👤 Account</div>
                <a href="/bank" class="{% if page == 'bank' %}active{% endif %}">Bank</a>
                <a href="/jail" class="{% if page == 'jail' %}active{% endif %}">Jail</a>
    ...
    <main class="content-wrap">
        <div class="topbar aaa-topbar">
            <div class="top-stat"><span>💸</span><small>CASH</small><b>${{ moneyfmt(user.money) }}</b></div>
            <div class="top-stat"><span>🍾</span><small>GIN</small><b>{{ warehouse_quantity(user, 'gin') }} L</b></div>
            <div class="top-stat"><span>⚔️</span><small>POWER</small><b>{{ moneyfmt(power_score(user)) }}</b></div>
            <div class="top-stat"><span>🔫</span><small>BULLETS</small><b>{{ moneyfmt(user.bullets) }}</b></div>
            <div class="top-stat"><span>👪</span><small>FAMILY</small><b>{% if user.family %}{{ user.family.name }}{% else %}Solo{% endif %}</b></div>
            <div class="top-stat"><span>⏱</span><small>SERVER TIME</small><b id="server-clock">--:--:--</b></div>
            <div class="top-icons"><span class="notification">✉<i>{{ unread_message_count(user) }}</i></span><span class="notification">🔔<i>{{ family_territory_count(user.family) if user.family else 0 }}</i></span></div>
        </div>
        {% if msg %}<div class="msg">{{ msg }}</div>{% endif %}
        <section class="aaa-hero page-hero-{{ page }}">
            <div class="hero-copy">
                <div class="hero-kicker">SHELBY COMPANY OPERATIONS</div>
                <h1>{{ page_title }}</h1>
                <p>Manage your empire with power, reputation and precision.</p>
            </div>
            <div class="hero-status">
                <div><small>LOCATION</small><b>{% if is_user_traveling(user) %}Travelling{% else %}{{ user.location }}{% endif %}</b></div>
                <div><small>RANK</small><b>{{ user.rank }}</b></div>
                <div><small>EXP</small><b>{{ exp_percent(user) }}%</b></div>
            </div>
        </section>
            ...
            <section class="s3-hero">
                <div>
                    ...
                    <div class="quick-actions">
                        ...
                        <a class="btn" href="/family">👪 Family HQ</a>
                ...
                <article class="s4-operation-card {% if crime_wait > 0 %}s4-disabled{% endif %}">
                    ...
                    <div class="s4-card-body">
                        <div class="s4-metrics">
                            ...
                            <div class="s4-metric"><small>EXP</small><b>{{ op.exp }}</b></div>
                ...
                <article class="s4-operation-card {% if heist_wait > 0 or not plan.ready %}s4-disabled{% endif %}">
                    ...
                    <div class="s4-card-body">
                        <div class="s4-metrics">
                            ...
                            <div class="s4-metric"><small>EXP</small><b>{{ plan.exp }}</b></div>
...
def render_page(user, page, **kwargs):
    return render_template_string(
        ...
        user=user,
        page=page,
        page_title=PAGE_TITLES.get(page, "Peaky Empire"),
